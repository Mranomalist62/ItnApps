                ...
                <div className="text-center">
                    ...
                    {['Bali', 'Yogyakarta','Jakarta','Surabaya','Bandung'].map((location) => (
                        ...
                        <p className="text-gray-600">
                            ...
                            {location === 'Yogyakarta' &&
                                "Cultural heart of Java with ancient temples, batik arts, and volcanic views"}
                            {location === 'Jakarta' &&
                                "Vibrant capital city blending modern living with rich Indonesian heritage"}
                            {location === 'Surabaya' &&
                                "Historic port city known for its colonial charm and dynamic urban energy"}
                            {location === 'Bandung' &&
                                "Cool mountain escape with art deco architecture and trendy culinary scenes"}
                        </p>
                        {preferences.location === location && (
                            <div className="mt-4 flex items-center justify-center">
                            <span className="bg-indigo-600 text-white p-1 rounded-full">
