    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
      ...
      <div className="flex flex-row align-middle md:flex-row items-center mb-4 mt-12 gap-4">
        ...
        <div>
          ...
          <p className="text-black ">Welcome back, Sarah!</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <section className="bg-white p-5 rounded-xl shadow-sm sticky top-6">
            ...
            <ul className="space-y-2 pt-2 border-t border-gray-500">
              <NavItem icon="🌋" label="Sign Out" active={activeMenu === "Sign Out"} onClick={() => setActiveMenu("Sign Out")} />
            </ul>
          </section>
        </div>
          ...
          <div className="md:col-span-1">
            <div className="text-center">
              <div className="relative inline-block">
                <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-4 bg-emerald-100">
                  <img
                    alt="Sarah Johnson"
                    loading="lazy"
                    width="128"
                    ...
                    src="/placeholder.svg?height=200&amp;width=200&amp;text=SJ"></img>
                </div>
              ...
              <button className="mt-4 inline-flex items-center text-red-600 hover:text-red-700 font-medium">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  className="lucide lucide-log-out mr-1">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  type="email"
                  value="sarah.johnson@example.com"></input>
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  type="text"
                  value="San Francisco, CA"></input>
              </div>
              <div className="pt-4">
                <button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
                  Save Changes
                </button>
              </div>
            </form>
